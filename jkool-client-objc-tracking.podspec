#
# Be sure to run `pod lib lint jkool-client-objc-tracking.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/jkool-client-objc-tracking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jKool developer' => 'support@jkoolcloud.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/jkool-client-objc-tracking.git', :tag => s.version.to_s }
